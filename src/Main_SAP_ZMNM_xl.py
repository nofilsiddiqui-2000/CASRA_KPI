...
# the correct SAP recording should be this one, the one in the code currently has some errors and was not selecting the parts by 3099:
...
# session.findById("wnd[0]/usr/ctxtSO_ERSDA-LOW").caretPosition = 0
# session.findById("wnd[0]").sendVKey 4
# session.findById("wnd[1]/usr/cntlCONTAINER/shellcont/shell").focusDate = "20260330"
# session.findById("wnd[1]/usr/cntlCONTAINER/shellcont/shell").firstVisibleDate = "20260216"
# session.findById("wnd[1]/usr/cntlCONTAINER/shellcont/shell").selectionInterval = "20260330,20260330"
# session.findById("wnd[0]/usr/ctxtSO_ERSDA-HIGH").setFocus
# session.findById("wnd[0]/usr/ctxtSO_ERSDA-HIGH").caretPosition = 0
# session.findById("wnd[0]").sendVKey 4
# session.findById("wnd[1]/usr/cntlCONTAINER/shellcont/shell").focusDate = "20260503"
# session.findById("wnd[1]/usr/cntlCONTAINER/shellcont/shell").selectionInterval = "20260503,20260503"
# session.findById("wnd[0]/usr/txtSO_ERNAM-LOW").setFocus
# session.findById("wnd[0]/usr/txtSO_ERNAM-LOW").caretPosition = 0
# session.findById("wnd[0]/usr/btn%_SO_ERNAM_%_APP_%-VALU_PUSH").press
# session.findById("wnd[1]/usr/tabsTAB_STRIP/tabpSIVA/ssubSCREEN_HEADER:SAPLALDB:3010/tblSAPLALDBSINGLE/txtRSCSEL_255-SLOW_I[1,0]").text = "B0516399"
...
# session.findById("wnd[0]/tbar[1]/btn[8]").press
# session.findById("wnd[0]/usr/cntlMY_AREA_CONTROL/shellcont/shell").pressToolbarButton "Z_DOWNLOAD"
# session.findById("wnd[1]/usr/ctxtRLGRAP-FILENAME").text = "zmnm_transaction.xls"
# session.findById("wnd[1]/usr/ctxtRLGRAP-FILENAME").caretPosition = 20
# session.findById("wnd[1]/tbar[0]/btn[0]").press
